"use client"
import { useGetCourseDetailsQuery, useAddReviewInReviewMutation } from '@/redux/features/course/courseApi';
...
const CourseDetailsPage: FC<Props> = ({ id }) => {
    ...
    const handleReviewReplySubmit = async (reviewID: string, comment: string) => {
        if (!comment.trim()) {
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
                                    {course.reviews.map((review: any, i: number) => (
                                        <ReviewCard
                                            ...
                                            replyLoading={replyReviewLoading}
                                            onReply={handleReviewReplySubmit}
                                        />
                                    ))}
                                </div>
                            ) : (
...
//     useCreatePaymentIntentMutation,
// } from '@/redux/features/orders/orderApi';
// import { useAddReviewInReviewMutation } from "@/redux/features/course/courseApi";
...
//                                                 commentReplies: review.commentReplies || [],
//                                             }}
//                                             canReply={user?.role === "admin"}
//                                             replyLoading={replyReviewLoading}
//                                             onReply={handleReviewReplySubmit}
